...
public class BattleSim {
    ...
    public void addArtist() {
        ...
        Band bandName = bandList.get(sc.nextInt() - 1);
        sc.nextLine(); //this gets rid of newline character
        ...
        if (type.equals("Singer")) {
            ...
            bandName.getMembers().add(new Singer(name, talent, range));
            System.out.println("Added singer " + name + " to " + bandName.getName());
            ...
            bandName.getMembers().add(new Guitarist(name, talent, sp));
            System.out.println("Added guitarist " + name + " to " + bandName.getName());
    ...
    public void addBand() {
        ...
        ArrayList<BandMember> newBand = new ArrayList<>();
        bandList.add(new Band(name, genre, newBand));
    ...
    public void changeRating() {
        ...
        if (band.getMembers().size() > 0) {
            ...
            BandMember b = (BandMember) band.getMembers().get(sc.nextInt() - 1);
            System.out.print("Talent rating from 1 to 5: ");
    ...
    /**
     * Lists the vocal ranges in enum Range.
     */
